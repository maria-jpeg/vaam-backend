...
public interface EfficientTree extends Cloneable
{
     ...
     *
     * @param srcPos  start of the block - source
     * @param destPos start of the block - destination
     * @param length  number of nodes to be moved
     */
     ...
     * Reorders nodes
     *
     * @param nodes A consecutive but possibly shuffled list of indices, in which
     *              to reorder nodes.
     * @param end   The index after the end of the last node.
     */
